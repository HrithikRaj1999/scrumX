...
exports.createTaskSchema = exports.getTasksSchema = void 0;
const zod_1 = require("zod");
exports.getTasksSchema = zod_1.z.object({
    projectId: zod_1.z.string().min(1, "projectId is required and cannot be empty"),
});
exports.createTaskSchema = zod_1.z.object({
    ...
    authorUserId: zod_1.z.number().min(1, "authorUserId is required and cannot be empty"),
